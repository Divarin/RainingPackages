          ...
          <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="583260897">
            ...
            <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="820740817">
              <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="2363511022" length="4">
                ...
                <item dataType="Struct" type="Duality.Components.Physics.PolyShapeInfo" id="633553262">
                  <density dataType="Float">1</density>
                  <friction dataType="Float">0.3</friction>
                  <parent dataType="ObjectRef">583260897</parent>
                  <restitution dataType="Float">0.3</restitution>
                  <sensor dataType="Bool">false</sensor>
                  <vertices dataType="Array" type="Duality.Vector2[]" id="232575266">
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">-702.6212</X>
                      <Y dataType="Float">-43.0023041</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">-633.687866</X>
                      <Y dataType="Float">-43.0023041</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">-617.468262</X>
                      <Y dataType="Float">-635.017761</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">-690.4565</X>
                      <Y dataType="Float">-630.9629</Y>
                    </item>
                  </vertices>
                </item>
                <item dataType="Struct" type="Duality.Components.Physics.PolyShapeInfo" id="2169293356">
                  <density dataType="Float">1</density>
                  <friction dataType="Float">0.3</friction>
                  <parent dataType="ObjectRef">583260897</parent>
                  <restitution dataType="Float">0.3</restitution>
                  <sensor dataType="Bool">false</sensor>
                  <vertices dataType="Array" type="Duality.Vector2[]" id="1972904568">
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">698.3469</X>
                      <Y dataType="Float">-43.0023041</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">698.3469</X>
                      <Y dataType="Float">-641.100159</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">647.660645</X>
                      <Y dataType="Float">-641.100159</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">645.63324</X>
                      <Y dataType="Float">-51.11212</Y>
                    </item>
                  </vertices>
                </item>
              </_items>
        ...
        <changes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Resources.PrefabLink+VarMod]]" id="3088231168">
          <_items dataType="Array" type="Duality.Resources.PrefabLink+VarMod[]" id="2299935388" length="8">
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              ...
              <componentType dataType="ObjectRef">2538858170</componentType>
              <prop dataType="MemberInfo" id="478194398" value="P:Duality.Components.Physics.RigidBody:Restitution" />
            ...
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              ...
              <componentType dataType="ObjectRef">23900956</componentType>
              <prop dataType="MemberInfo" id="994000674" value="P:RainingPackages.GameObjects.Player:MoveUnits" />
            ...
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              ...
              <componentType dataType="ObjectRef">2538858170</componentType>
              <prop dataType="MemberInfo" id="1571886982" value="P:Duality.Components.Physics.RigidBody:Friction" />
            ...
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              ...
              <componentType dataType="ObjectRef">2538858170</componentType>
              <prop dataType="MemberInfo" id="2978303242" value="P:Duality.Components.Physics.RigidBody:Mass" />
              <val dataType="Float">114.9</val>
            </item>
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              <childIndex dataType="Struct" type="System.Collections.Generic.List`1[[System.Int32]]" id="2593900408">
                <_items dataType="ObjectRef">2479715600</_items>
                <_size dataType="Int">0</_size>
                <_version dataType="Int">1</_version>
              </childIndex>
              <componentType dataType="ObjectRef">2538858170</componentType>
              <prop dataType="MemberInfo" id="2052346926" value="P:Duality.Components.Physics.RigidBody:LinearDamping" />
              <val dataType="Float">0.3</val>
            </item>
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              ...
              <componentType dataType="ObjectRef">23900956</componentType>
              <prop dataType="MemberInfo" id="796221362" value="P:RainingPackages.GameObjects.Player:JumpUnits" />
              <val dataType="Float">20</val>
            </item>
          </_items>
          <_size dataType="Int">6</_size>
          <_version dataType="Int">114</_version>
        </changes>
