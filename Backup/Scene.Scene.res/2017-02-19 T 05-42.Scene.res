<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
    ...
    <item dataType="Struct" type="Duality.GameObject" id="532092309">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1859823591">
        <_items dataType="Array" type="Duality.Component[]" id="2323690830">
          <item dataType="Struct" type="Duality.Components.Transform" id="2892407241">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">532092309</gameobj>
          </item>
          <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="2174258877">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">532092309</gameobj>
          </item>
          <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="3594868833">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">532092309</gameobj>
          </item>
          <item dataType="Struct" type="RainingPackages.GameObjects.Drone.DroneControl" id="1705342147">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">532092309</gameobj>
          </item>
        </_items>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2854556544" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Object[]" id="2077142221">
            <item dataType="ObjectRef">2122539126</item>
            <item dataType="ObjectRef">470219302</item>
            <item dataType="ObjectRef">2538858170</item>
            <item dataType="Type" id="999706662" value="RainingPackages.GameObjects.Drone.DroneControl" />
          </keys>
          <values dataType="Array" type="System.Object[]" id="2983195320">
            <item dataType="ObjectRef">2892407241</item>
            <item dataType="ObjectRef">2174258877</item>
            <item dataType="ObjectRef">3594868833</item>
            <item dataType="ObjectRef">1705342147</item>
          </values>
        </body>
      </compMap>
      <compTransform dataType="ObjectRef">2892407241</compTransform>
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="3857579687">DVwSe6WzPEmgvteA2W5opA==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
      ...
      <parent />
      <prefabLink dataType="Struct" type="Duality.Resources.PrefabLink" id="2655943077">
        <changes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Resources.PrefabLink+VarMod]]" id="709574228">
          <_items dataType="Array" type="Duality.Resources.PrefabLink+VarMod[]" id="184784100" length="4">
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              <childIndex dataType="Struct" type="System.Collections.Generic.List`1[[System.Int32]]" id="3372517576">
                <_items dataType="Array" type="System.Int32[]" id="3513383532"></_items>
                <_size dataType="Int">0</_size>
                <_version dataType="Int">1</_version>
              </childIndex>
              <componentType dataType="ObjectRef">2122539126</componentType>
              <prop dataType="MemberInfo" id="3770950366" value="P:Duality.Components.Transform:RelativePos" />
              <val dataType="Struct" type="Duality.Vector3">
                <X dataType="Float">0</X>
                <Y dataType="Float">114.926895</Y>
                <Z dataType="Float">0</Z>
              </val>
            </item>
          </_items>
        ...
        <obj dataType="ObjectRef">532092309</obj>
        <prefab dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Prefab]]">
          <contentPath dataType="String">Data\drone.Prefab.res</contentPath>
        </prefab>
      </prefabLink>
    </item>
    <item dataType="Struct" type="Duality.GameObject" id="1444435090">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2859062140">
        <_items dataType="Array" type="Duality.Component[]" id="1992535108" length="4">
          <item dataType="Struct" type="Duality.Components.Transform" id="3804750022">
            <active dataType="Bool">true</active>
            <angle dataType="Float">0</angle>
            <angleAbs dataType="Float">0</angleAbs>
            <angleVel dataType="Float">0</angleVel>
            <angleVelAbs dataType="Float">0</angleVelAbs>
            <deriveAngle dataType="Bool">true</deriveAngle>
            <gameobj dataType="ObjectRef">1444435090</gameobj>
            <ignoreParent dataType="Bool">false</ignoreParent>
            <parentTransform />
            <pos dataType="Struct" type="Duality.Vector3">
              <X dataType="Float">0</X>
          ...
          <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="3086601658">
            <active dataType="Bool">true</active>
            <colorTint dataType="Struct" type="Duality.Drawing.ColorRgba">
              <A dataType="Byte">255</A>
              <B dataType="Byte">255</B>
          ...
          <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="212244318">
            <active dataType="Bool">true</active>
            <angularDamp dataType="Float">0.3</angularDamp>
            <angularVel dataType="Float">0</angularVel>
            ...
            <linearVel dataType="Struct" type="Duality.Vector2" />
            <revolutions dataType="Float">0</revolutions>
            <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="2297295430">
              <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="447086592" length="4">
                <item dataType="Struct" type="Duality.Components.Physics.PolyShapeInfo" id="389519516">
                  <density dataType="Float">1</density>
                  <friction dataType="Float">0.3</friction>
                  <parent dataType="ObjectRef">212244318</parent>
                  <restitution dataType="Float">0.3</restitution>
                  <sensor dataType="Bool">false</sensor>
                  <vertices dataType="Array" type="Duality.Vector2[]" id="3990086596">
                    <item dataType="Struct" type="Duality.Vector2">
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="3893375126" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Object[]" id="4137433046">
            <item dataType="ObjectRef">2122539126</item>
            <item dataType="ObjectRef">470219302</item>
            <item dataType="ObjectRef">2538858170</item>
          </keys>
          <values dataType="Array" type="System.Object[]" id="389891034">
            <item dataType="ObjectRef">3804750022</item>
            <item dataType="ObjectRef">3086601658</item>
            <item dataType="ObjectRef">212244318</item>
          </values>
        </body>
      </compMap>
      <compTransform dataType="ObjectRef">3804750022</compTransform>
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="3222508790">RB5AcliTDUqrsLc1Rq3G2w==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
      ...
      <parent />
      <prefabLink dataType="Struct" type="Duality.Resources.PrefabLink" id="610913064">
        <changes />
        <obj dataType="ObjectRef">1444435090</obj>
        <prefab dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Prefab]]">
          <contentPath dataType="String">Data\package.Prefab.res</contentPath>
        </prefab>
      </prefabLink>
    </item>
  </serializeObj>
