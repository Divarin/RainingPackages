        ...
        <_items dataType="Array" type="Duality.Component[]" id="3441551632" length="4">
          <item dataType="Struct" type="RainingPackages.TextRenderers.DebugTextRenderer" id="4221861129">
            <_texts dataType="Struct" type="System.Collections.Generic.List`1[[System.String]]" id="2875919821">
              ...
              <_size dataType="Int">0</_size>
              <_version dataType="Int">17800</_version>
            </_texts>
            <active dataType="Bool">true</active>
              ...
              <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="4079481966" length="64">
                <item dataType="Struct" type="Duality.Components.Physics.LoopShapeInfo" id="3886095952">
                  ...
                  <vertices dataType="Array" type="Duality.Vector2[]" id="1212464572">
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">-1191.20435</X>
                      <Y dataType="Float">-232.464966</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">-419.567352</X>
                      <Y dataType="Float">-82.92285</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">41.0221863</X>
                      <Y dataType="Float">48.6740723</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">609.282</X>
                      <Y dataType="Float">246.06958</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">1033.98132</X>
                      <Y dataType="Float">395.6117</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">1069.87146</X>
                      <Y dataType="Float">527.20874</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">-664.8163</X>
                      <Y dataType="Float">515.245361</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">-1227.09436</X>
                      <Y dataType="Float">485.3369</Y>
                    </item>
                  </vertices>
                </item>
              </_items>
              <_size dataType="Int">1</_size>
              <_version dataType="Int">285</_version>
            </shapes>
          </item>
        </_items>
        <_size dataType="Int">3</_size>
