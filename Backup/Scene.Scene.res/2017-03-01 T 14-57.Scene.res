        ...
        <_items dataType="Array" type="Duality.Component[]" id="3441551632" length="4">
          <item dataType="Struct" type="RainingPackages.TextRenderers.DebugTextRenderer" id="4221861129">
            <_texts dataType="Struct" type="System.Collections.Generic.List`1[[System.String]]" id="2875919821">
              ...
              <_version dataType="Int">99150</_version>
            </_texts>
            <active dataType="Bool">true</active>
              ...
              <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="4079481966" length="64">
                <item dataType="Struct" type="Duality.Components.Physics.ChainShapeInfo" id="3886095952">
                  ...
                  <vertices dataType="Array" type="Duality.Vector2[]" id="1212464572">
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">-806.5234</X>
                      <Y dataType="Float">-304.623779</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">799.582764</X>
                      <Y dataType="Float">-297.760132</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">2000.73462</X>
                      <Y dataType="Float">-1498.97217</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">2023.61353</X>
                      <Y dataType="Float">-1476.09314</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">4578.096</X>
                      <Y dataType="Float">-1482.95679</Y>
                    </item>
                  </vertices>
                </item>
                <item dataType="Struct" type="Duality.Components.Physics.ChainShapeInfo" id="2301607278">
                  ...
                  <vertices dataType="Array" type="Duality.Vector2[]" id="901907234">
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">-378.709717</X>
                      <Y dataType="Float">-151.412354</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">-2307.147</X>
                      <Y dataType="Float">-1565.59985</Y>
                    </item>
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">-3592.772</X>
                      <Y dataType="Float">-1554.88623</Y>
                    </item>
                  </vertices>
                </item>
              </_items>
              <_size dataType="Int">2</_size>
              <_version dataType="Int">760</_version>
            </shapes>
          </item>
        </_items>
        <_size dataType="Int">3</_size>
